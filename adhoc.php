...
insert into User values ('test1', 'TestFirstName', 'TestLastName', 'test user', 'ttt') 

update User set FirstName = "NewFirstName" where Username = "test1"
